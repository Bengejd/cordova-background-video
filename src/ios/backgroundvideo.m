...
- (void) start:(CDVInvokedUrlCommand *)command
{
    ...
    //make the view
    CGRect viewRect = CGRectMake(0, 0, self.webView.superview.frame.size.width, self.webView.superview.frame.size.height);
    ...
    CMTime maxDuration = CMTimeMakeWithSeconds(10, 1); // Changed the limit to be just 10 seconds.
